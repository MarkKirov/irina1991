  ...
  return (
    <div className="min-h-screen px-4 py-8 md:py-12 max-w-2xl mx-auto">
      ...
      <div className="space-y-5 text-[15px] leading-relaxed text-foreground">
        ...
        <p className="text-muted-foreground pt-2">
          Заполняй анкету предзаписи, чтобы узнать подробности менторской группы.
          Эта анкета тебя ни&nbsp;к&nbsp;чему не&nbsp;обязывает. После её заполнения
          я&nbsp;свяжусь с&nbsp;тобой, чтобы обсудить твой запрос, и&nbsp;ты поймёшь,
          подходит&nbsp;ли тебе такой формат работы.
        </p>
      </div>
