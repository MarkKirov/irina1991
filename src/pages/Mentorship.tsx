  ...
  return (
    <div className="min-h-screen px-4 py-8 md:py-12 max-w-2xl mx-auto">
      ...
      <div className="space-y-5 text-[15px] leading-relaxed text-foreground">
        <p>
          <strong>Поздравляю!</strong> Ты только что сделала то, на что у&nbsp;многих уходят
          месяцы&nbsp;— выгрузила хаос из головы и&nbsp;нашла свои истинные точки роста.
          Чувствуешь, как стало легче дышать?
        </p>

        <p className="text-muted-foreground">
          Но я&nbsp;знаю, как это бывает: неделя заканчивается, и&nbsp;старые привычки
          «хвататься за&nbsp;всё сразу» пытаются вернуться. Чтобы этого не&nbsp;случилось,
          нужна не&nbsp;просто разовая выгрузка, а&nbsp;<strong className="text-foreground">система</strong>.
        </p>
